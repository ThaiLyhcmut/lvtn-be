...
import (
	...
	resolver "thaily/services/auth/resolvers"
...
func main() {
	var (
		...
		jwtSecret   = flag.String("jwt-secret", getEnv("JWT_SECRET", "your-secret-key"), "JWT secret key")
	)
	flag.Parse()
	...
	service := resolver.NewAuthService(mongoAdapter, *jwtSecret)
